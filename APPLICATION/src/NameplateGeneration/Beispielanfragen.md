...
## Ein anderes mit Markings (Gibt nur das CE marking)
```json
{
...
## Eines, bei dem aus irgendeinem Grund die Bilddateien nicht geladen werden können. 
Das scheint ein Fehler im Asset zu sein. :/

Sollte das Programm aber handeln können. Wenn die Bilder einfach blank sind, dann perfekt, wenn ich den Fehler vorher abfangen sollte, sag bescheid.
...
## V1 Asset mit Markings (V1 gibts nur ohne Bilder)
Hier auch gerne Feedback, ob ich was für die V1 API übersehen habe, was du noch brauchst
```json
{
...
## V1 Asset mit "AssetSpecificProperties"
Das sind irgendwelche Assets von Murrelectronic bei admin-shell-io. 
Die sind echt Wild

Mein V1 leser scheint aber nicht richtig zu tun. Datenfelder sind irgendwie leer. Hier aber schon mal ein Vorgeschmack.

Das erste V1 Asset sollte aber passen.
...
## V1 Asset mit Sicherheits Marking (First of its kind)
Bitte fang nich an zu kotzen. 

Auch hier: Mein V1 leser tut nicht und viele Datenfelder sind leer. Und Markings hat nen extra Wrapper. 

Ich kann wohl die Version der Assets nicht Serverweit bestimmen...

```json
{
  "idShort": "Murrelektronik_54600_SN12214554",
  "id": "https://aas.murrelektronik.com/aas/1/0/DE12102255",
  "idEncoded": "aHR0cHM6Ly9hYXMubXVycmVsZWt0cm9uaWsuY29tL2Fhcy8xLzAvREUxMjEwMjI1NQ==",
  "nameplateId": "https://aas.murrelektronik.com/54600/sm/1/0/de02143657/nameplate",
  "nameplateIdEncoded": "aHR0cHM6Ly9hYXMubXVycmVsZWt0cm9uaWsuY29tLzU0NjAwL3NtLzEvMC9kZTAyMTQzNjU3L25hbWVwbGF0ZQ==",
  "num": 33,
  "productImages": [],
  "nameplate": {
    "idShort": "Nameplate",
    "id": "https://aas.murrelektronik.com/54600/sm/1/0/de02143657/nameplate",
    "idEncoded": "aHR0cHM6Ly9hYXMubXVycmVsZWt0cm9uaWsuY29tLzU0NjAwL3NtLzEvMC9kZTAyMTQzNjU3L25hbWVwbGF0ZQ==",
    "URIOfTheProduct": "https://shop.murrelektronik.com/54600/",
    "ManufacturerName": "",
    "ManufacturerProductDesignation": "",
    "Address": {
      "Department": "",
