# Nameplates mit überarbeitetm V1 Algorithmus
Habe die Probleme behoben. 

Nochmal die gleichen Assets wie letztes Mal.

Die Überschriften für die jeweiligen JSONs sind die API Version mit dem Namen des Assets.

## V3 ARGO_HYTOS_Return_Filter_ES075
...
## V3 AAS_Type_SPAU-P10R-T-G18M-L-PNLK-PNVBA-M8D
```json
{
  "idShort": "Nameplate",
...
## V1 Murrelektronik_M12_Male_M12_Female_A_Kod_AAS
```json
{
  "idShort": "Nameplate",
...
## V1 Murrelektronik_58841_SN12214554
Ist immernoch viel Junk drin, aber die Daten, die jetzt fehlen gibt es auch auf dem Server nicht. Viel davon sind so Qualifier attribute. Keine Ahnung was die wieder machen, aber soweit ich weiß, ist das für uns auch nicht wichtig.
```json
{
  "idShort": "Nameplate",
