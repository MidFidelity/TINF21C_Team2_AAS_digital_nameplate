...
|Who should focus on which part of the project?                |Mika Kuge, Janin Ahlemeyer, Maris Koch and Erika Zhang will primarily focus on coding, while Sophie Kirschner and Adrian Khairi will focus on the documents or rather the documentation.                             |
|Which platforms do we want to use? Maybe Discord and Github?                |We decided to use Discord and Github. Discord will be used for the communication, while Github will be utilized for the documentation and code. Mika Kuge will set up the platforms for usage.                             |
...
|Who protocols the weeklys and writes an agenda?                |Adrian Khairi will be the one in charge for protocoling the weeklys and writing an agenda.                            |
...
|Agenda          |Summary                      |
|----------------|-----------------------------|
|Who will operate as a crucial interface or rather junction between the people focussing primarily on coding and documentation?               |Erika Zhang will be the crucial junction between those two groups. Everyone will know certain aspects of each code part and document, but Erika Zhang will know the details to spread some information between the subteams, whenever needed.                             |
...
|Information @all: At the end of the third semester, this documents should be finished and submitted:<ul><li>presentation</li><li>meeting protocols</li><li>CRS, BC, SRS, SAS and the project plan</li></ul>           |This information was shared with all team members.                             |
...
|Information @all: Every subteam should think of their primary goal for the third semester and for the project in general.Try to make those goals as specific and precise as possible. Please inform Adrian Khairi about those goals due to the 26.09. end of business. Those informations are needed for some documents.|This information was shared with all team members.|
